...
/**
 * This abstract class is used to represent the view of the game; it will be extended in class Cli and Gui, the real
 * view of the game
 */
public abstract class View {
     ...
     * @param newGameInfo the new gameInfo, it will be used to update the view
     */
    ...
    /**
     * This method is called by the client main to start the view; at the beginning it will be asked the nickName
     * the player wants, then if he wants to create a new game or join an existing one; then the player wait for
     * another players
     */
    ...
    /**
     * This method is called by parseCommand to check if it's the player's turn, if not it will not send the
     * command to the server; to check this, we compare the nickname with the currentPlayer nickname in the gameInfo
     ...
     * position is in the board, if the tile isn't invalid or empty and if the tile has free adjacent(calling a
     ...
     *
     * @param positions list of positions already chosen by the player
    ...
    /**
     * this method receive the List of the next position the player can choose after the previous moves and return
     * the List of the next positions that are not empty or invalid (valid positions)
    ...
    /**
     * this method check if the column chosen by the player is valid
    ...
    /**
     * This method is called to print a message in the chat on the screen
     * @param message the message to display
     */
    ...
    /**
     * this method is used to parse the final leaderboard of the game as a string
     * @return a string containing the final leaderboard (player, finalPoints of the player)
     */
